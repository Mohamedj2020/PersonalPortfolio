            ...
            <div className="relative">
              ...
              {experiences.map((exp, index) => (
                <div key={index} className="relative mb-12 last:mb-0">
                  ...
                  <div className={`w-full pl-12 sm:pl-16 md:pl-0 md:w-5/12 ${index % 2 === 0 ? 'md:pr-8 md:text-right' : 'md:ml-auto md:pl-8'}`}>
                    <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-teal-400/50 transition-all duration-300 shadow-md">
                      ...
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-2 mb-2">
                        <div>
                          ...
                          <p className="text-teal-300 text-sm sm:text-base">{exp.organization}</p>
                        </div>
                        <span className="text-gray-400 text-xs sm:text-sm sm:text-right">{exp.period}</span>
                      </div>

                      {/* Description */}
                      <p className="text-gray-300 text-sm sm:text-base leading-relaxed mt-2">{exp.description}</p>
                    </div>
                  </div>
                </div>
              ))}
